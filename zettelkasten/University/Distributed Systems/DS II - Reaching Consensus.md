...
- also the rounds must be assigned so that each proposer has infinite rounds (i.e. proposer $\sigma \upsilon \sigma$ has round $1,3,5,7$ and another one has $0,2,4,6$ and so on)
